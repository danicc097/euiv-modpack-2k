...
NDiplomacy = {
	...
	INCREASE_TRUST_COST = 20,						-- Cost in favors to increase trust
	...
	FAVORS_LAND_DIVIDER = 3,						-- How many favors do you get for giving other countries land? (divider on development)
	...
	TRUST_PENALTY_FOR_NO_LAND = 40,					-- Trust penalty for not being given as much land as they expected in peace deal (scales with how much they actually got relative to participation)
...
NCountry = {
	...
	MIN_DEVELOPMENT_FOR_GOV_RANK_2 = 150,		-- Need at least this much development to upgrade to government rank 2
	...
	PS_ESTABLISH_SIBERIAN_FRONTIER = 75,
	...
	CORE_LOSE = 150, 								-- how many years until a core is lost.
	...
	MAX_NATIONALISM = 300,							-- how much extra nationalism can there be in a province, added with the effect, not by conquering
	...
	RELEASED_NATION_ARMY_SIZE = 0.75,				-- Newly released nations get an army of this size
	STARTING_ARMY_SIZE = 0.85,						-- Percentage of force limit
	...
	REVOLT_SIZE_DEVELOPMENT_MULTIPLIER = 0.28,		-- Multiplied with the province's development
	REVOLT_SIZE_BASE = 0.9,
